...
var _=r[a],m=_.getAttribute("data-src")||"",p=_.getAttribute("src")||m;
if(p){
...
function i(e){
var t=e.getAttribute("data-src")||e.getAttribute("src"),i=p.getQuery("vid",t),a=e.getAttribute("data-vw"),n=e.getAttribute("data-vh"),o=e.getAttribute("data-ratio"),s=document.createElement("span");
...
allowFullScreen:!0,
onSuccess:function(e){
s.playerObj=e.player,r(s,i),s.style.display="block";
},
onError:function(){}
...
i.show){
{
var a=document.getElementById("js_read_area3"),n=document.getElementById("like3"),o=document.getElementById("like_old"),_=document.getElementById("likeNum3"),m=document.getElementById("likeNum_old"),c=document.getElementById("readNum3");
...
}),window.isPaySubscribe&&d.init(r);
var f=document.getElementById("js_cmt_container");
if(1==t.comment_entrance_enable_for_preview&&window.is_temp_url&&f&&(f.style.display="block"),
...
})),t.comment_enabled&&f&&(f.style.display="block"),A.isIOS&&"block"===f.style.display&&location.href.match(/fontScale=\d+/)&&I.os.ipad&&I.os.getNumVersion()>=13){
var k=location.href.match(/fontScale=(\d+)/);
z(f,parseFloat(k[1])/100);
}
}
function o(){
...
void b.invoke("handleMPPageAction",{
action:"paySuccess",
...
f("[Appmsg] error parse async data, biz="+biz+", mid="+mid);
var m=new Image;
...
e("biz_common/dom/event.js")),b=(e("biz_wap/utils/ajax.js"),e("biz_wap/jsapi/core.js")),v=e("biz_common/tmpl.js"),f=(e("complain/localstorage.js"),
